...
export default function Chat() {
  ...
  const handleCreateConversation = async () => {
    ...
    if (targetType === "team" && !targetTeamId.trim()) {
  ...
  const handleSelectTeam = async (teamId: string) => {
    ...
    try {
      ...
      setSelectedId(id);
      await loadMessages(id);
      toast.success("Conversa da equipe aberta");
    } catch (e: any) {
          ...
          <Card className="lg:col-span-1">
            ...
            <CardContent className="space-y-3">
              <div className="space-y-2">
                <Label className="text-xs text-muted-foreground">Tipo de conversa</Label>
                <Select value={targetType} onValueChange={(v) => setTargetType(v as "user" | "team")}>
                  <SelectTrigger>
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent>
              ...
              {targetType === "user" ? (
                ...
                <>
                  <Select value={targetTeamId} onValueChange={handleSelectTeam} disabled={creating}>
                    <SelectTrigger>
              ...
              <Button
                ...
                disabled={creating || (targetType === "user" ? !targetUserId : !targetTeamId)}
              >
